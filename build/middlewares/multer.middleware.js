...
const uploader = () => {
    ...
    // 5MB
    //! allowed extensions
    const allowed_ext = ["jpg", "jpeg", "webp", "svg", "png", "gif"];
    ...
    const fileFilter = (req, file, cb) => {
        ...
        if (is_allowed) {
            ...
            cb(new error_handler_middleware_1.default(`Invalid file type.Only ${allowed_ext.join(",")}
                        are allowed`, enum_types_1.ERROR_CODES.VALIDATION_ERR, 400));
        }
    };
    //!upload instance
